...
/**
 * Logging for data delivering to client for second namespace of join
 * 
 */
var logDataDeliveredEventJoinSecTable = function(logHolder, dataSize, queryId) {
	logHolder.emitEvent(constants.LOG_INFO, [ trimQueryId(queryId), "Data delivered for second namespace request." ]);

	logHolder.emitEvent(constants.LOG_FINE, [ trimQueryId(queryId),
			"Data of size " + dataSize + " delivered to requester  for second namespace request." ]);
...
module.exports.logDataDeliveredEventJoinSecTable = logDataDeliveredEventJoinSecTable;