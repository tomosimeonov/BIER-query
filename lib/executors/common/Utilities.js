...
var produceUnmarshallerDataFunction = function(schema, aggregations, callback, secondSchema) {
	...
	if (secondSchema) {
		for ( var key in schema.properties)
			properties[schema.table + "." + key] = schema.properties[key];
		for ( var key in secondSchema.properties)
			properties[secondSchema.table + "." + key] = secondSchema.properties[key];
	} else {
