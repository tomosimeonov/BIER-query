...
JoinExecutor.prototype.updateWithLocalMatch = function(queryId) {
	...
	this.storageApis.Node.lscan(this.runningQueries[queryId].configuration.namespaceOne, function(localData) {
		...
		if (localData.length !== 0) {
			...
			that.filterDataOnPropValues(queryId, that.runningQueries[queryId].configuration.namespaceTwo,
					that.runningQueries[queryId].configuration.joinPropertyTwo, values, function(data) {
