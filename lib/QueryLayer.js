...
function QueryLayer(storageApis) {
	...
	self.dataInsertSQLPlanRunner = mainConfiguration.createDataInsertRunner(storageApis);
	self.schemaInsertSQLPlanRunner = mainConfiguration.createSchemaInsertRunner(storageApis);
	self.simpleSelectSQLPlanRunner = mainConfiguration.createSimpleSelectSQLPlanRunner(self.simpleExecutor);
	self.joinSelectSQLPlanRunner = mainConfiguration.createJoinSelectSQLPlanRunner(self.joinExecutor);
	return self;
}
