...
DataInsertSQLPlanRunner.prototype.decodeInsertStatementPlan = function(insertPlan, keyName, callback) {
	var data = {};
...
DataInsertSQLPlanRunner.prototype.areValuesSatisfingSchema = function(columns,values,schema,callback){
