...
function QueryExecutor(storageApis, statisticHolder) {
	...
	self.defaultTimeoutInMillis = 4000;
...
QueryExecutor.prototype.message = function(message) {
...
QueryExecutor.prototype.sendQuery = function(queryId) {
	var that = this;
...
QueryExecutor.prototype.executeNonRegQueryOnRemoteCall = function(queryId, configuration, origin) {
	var that = this;
