...
AggregationHelper.prototype.processData = function(data, properties, aggregs, nodeId, wasOnlyAggregation, primaryKey,
		callback) {
	...
	var aggregationData = tempData.reduce(function(previousValue, currentValue, index, array) {
		aggregs.forEach(function(el) {
			...
			if (previousValue[id]) {
				...
				if (currentValue[id] && !notOnlyAggregation) {
